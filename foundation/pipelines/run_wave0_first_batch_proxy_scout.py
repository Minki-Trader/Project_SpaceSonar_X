...
def write_next_work_item(results: list[dict[str, Any]]) -> None:
    ...
    payload = {
        ...
        "acceptance_criteria": [
            ...
            "If narrowing or axis rotation is material, consult 2-4 relevant agents before opening the next sweep.",
        ...
        "agent_allocation": {
            ...
            "selected_agents": [],
            "role_modes": [],
            "selection_reason": "Next material axis decision should consult 2-4 relevant agents during that work item.",
            "why_not_smaller": "Codex can prepare the review entrypoint; actual axis decision may need agents.",
            "why_not_larger": "Full roster is not needed unless protected claims or terminal closeout appear.",
            "max_threads_is_capacity_only": True,
            "claim_effect": "no_advisory_claim_yet",
        },
        "runtime_learning_probe_decision": {
            "required": True,
