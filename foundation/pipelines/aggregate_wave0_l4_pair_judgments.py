...
def main(argv: list[str] | None = None) -> int:
    ...
    started_at = utc_now()
    command_argv = ["python", "foundation/pipelines/aggregate_wave0_l4_pair_judgments.py"]
        ...
        json.dumps(
            {
                ...
                "pair_count": len(rows),
                "both_period_roles_observed_count": summary["counts"]["both_period_roles_observed_count"],
                "claim_boundary": summary["claim_boundary"],
            },
            indent=2,
        )
