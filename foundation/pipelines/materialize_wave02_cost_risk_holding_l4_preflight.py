...
from foundation.features.wave02_cost_risk_holding_features import build_wave02_cost_risk_holding_features  # noqa: E402
from foundation.labels.wave02_cost_risk_holding_labels import build_wave02_cost_risk_holding_labels  # noqa: E402
from foundation.onnx.skl2onnx_adapters import convert_sklearn_pipeline_for_lab  # noqa: E402
from foundation.pipelines.run_wave02_cost_risk_holding_proxy_batch import (  # noqa: E402
    build_model_target,
    load_row_membership,
    model_family,
    split_masks,
...
WORK_ITEM_ID = "work_wave02_cost_risk_holding_l4_materialization_preflight_v0"
NEXT_WORK_ITEM_ID = "work_wave02_cost_risk_holding_l4_runtime_execution_v0"
...
CLOSEOUT_PATH = Path("lab/goals") / GOAL_ID / "work_wave02_cost_risk_holding_l4_materialization_preflight_v0_closeout.yaml"
...
COMMON_REL_ROOT = "SpaceSonar\\wave02_cost_risk_holding_l4_score_probe"
EA_EXPERT_CONFIG_PATH = "Project_SpaceSonar_X\\foundation\\mt5\\experts\\SpaceSonar_ONNX_L4_ScoreProbe.ex5"

BUNDLE_CLAIM_BOUNDARY = (
    "wave02_cost_risk_holding_l4_onnx_bundle_preflight_python_parity_only_no_runtime_authority_"
    "no_economics_pass_no_candidate_no_live_readiness_no_goal_achieve"
)
ATTEMPT_CLAIM_BOUNDARY = (
    "wave02_cost_risk_holding_l4_strategy_tester_attempt_preparation_only_no_runtime_authority_"
    "no_economics_pass_no_candidate_no_live_readiness_no_goal_achieve"
)
NEXT_CLAIM_BOUNDARY = (
    "wave02_cost_risk_holding_l4_attempts_prepared_terminal_execution_pending_no_runtime_authority_"
    "no_economics_pass_no_candidate_no_live_readiness_no_goal_achieve"
)
ONNX_STATUS = "onnx_exported_python_onnxruntime_parity_passed"
ATTEMPT_STATUS = "prepared_pending_terminal_execution"
CAMPAIGN_STATUS = "wave02_cost_risk_holding_l4_attempts_prepared_terminal_execution_next"
...
def cell_id_from_run_id(run_id: str) -> str:
    match = re.search(r"(wave02_crh_cell_\d{3})", run_id)
    if not match:
        raise ValueError(f"cannot derive Wave02 cost/risk/holding cell_id from run_id={run_id}")
...
def materialize_bundle(
    *,
    ...
    feature_schema_contract = {
        ...
        "boundary": "right_aligned_US100_M5_closed_bar_wave02_cost_risk_holding_features",
    ...
    bundle = {
        ...
        "task_surface": {
            "task_type": "cost_risk_holding_tradeability_proxy",
            "target_or_label": refs["label_recipe_id"],
            "direction_mapping": "cost_risk_holding_proxy_score_not_runtime_authority",
            "output_head": "single_score_for_L4_non_trading_score_probe",
        },
        "decision_use": "wave02_score_telemetry_preflight_for_cost_risk_holding_surface",
        ...
        "decision_surface": {
            ...
            "risk_variant": str(axis_values["risk_variant"]),
        ...
        "model_family": model_family_name,
        "model_task": "wave02_cost_risk_holding_classification",
        ...
        "parser_version": "spacesonar_wave02_cost_risk_holding_l4_preflight_v0",
        ...
        "proxy_runtime_parity": {
            ...
            "known_differences": [
                ...
                "Wave02 cost/risk/holding decision recipes may use label, risk, and holding variants; this L4 score probe records non-trading score telemetry only.",
            ...
            "interpretation_drift_risks": [
                ...
                "cost_risk_holding_label_context_not_available_to_score_only_EA",
            ...
            "prevention_memory": [
                ...
                "Do not convert Wave02 cost/risk/holding proxy metrics into economics claims from score telemetry.",
    ...
    return {
        ...
        "proxy_runtime_parity": {
            ...
            "prevention_memory": [
                ...
                "Do not infer cost/risk/holding economics from non-trading score telemetry.",
            ],
...
def build_summaries(
    *,
    ...
    onnx_summary = {
        "version": "wave02_cost_risk_holding_l4_onnx_materialization_summary_v1",
        "summary_id": "wave02_cost_risk_holding_l4_onnx_materialization_summary_v0",
        "work_item_id": WORK_ITEM_ID,
        "active_goal_id": GOAL_ID,
        "campaign_id": CAMPAIGN_ID,
        "sweep_id": SWEEP_ID,
    ...
    attempt_summary = {
        "version": "wave02_cost_risk_holding_l4_attempt_preparation_summary_v1",
        "summary_id": "wave02_cost_risk_holding_l4_attempt_preparation_summary_v0",
        "work_item_id": NEXT_WORK_ITEM_ID,
        "preparation_work_item_id": WORK_ITEM_ID,
        "active_goal_id": GOAL_ID,
        "campaign_id": CAMPAIGN_ID,
        ...
        "prevention_memory": [
            ...
            "Wave02 cost/risk/holding proxy semantics require a later decision-execution adapter before economics can be discussed.",
        ],
...
def upsert_artifact_registry(bundle_rows: list[dict[str, Any]], attempt_rows: list[dict[str, Any]]) -> None:
    ...
    producer = "foundation/pipelines/materialize_wave02_cost_risk_holding_l4_preflight.py --write-control-records --copy-common-files"
    ...
    for artifact_id, artifact_type, path, claim, notes in [
        ("artifact_wave02_crh_l4_writer_precheck_v0", "writer_contract_precheck", PRECHECK_SUMMARY.as_posix(), NEXT_CLAIM_BOUNDARY, "writer contract guard record"),
        ("artifact_wave02_crh_l4_onnx_materialization_summary_v0", "l4_onnx_materialization_summary", ONNX_SUMMARY.as_posix(), BUNDLE_CLAIM_BOUNDARY, "ONNX bundle preflight summary"),
        ("artifact_wave02_crh_l4_onnx_materialization_index_v0", "l4_onnx_materialization_index", ONNX_INDEX.as_posix(), BUNDLE_CLAIM_BOUNDARY, "ONNX bundle preflight index"),
        ("artifact_wave02_crh_l4_attempt_preparation_summary_v0", "l4_attempt_preparation_summary", ATTEMPT_SUMMARY.as_posix(), ATTEMPT_CLAIM_BOUNDARY, "prepared attempt summary; terminal execution pending"),
        ("artifact_wave02_crh_l4_attempt_preparation_index_v0", "l4_attempt_preparation_index", ATTEMPT_INDEX.as_posix(), ATTEMPT_CLAIM_BOUNDARY, "prepared attempt index"),
        ("artifact_wave02_crh_l4_score_probe_ea_source_v0", "mt5_ea_source", EA_SOURCE.as_posix(), ATTEMPT_CLAIM_BOUNDARY, "non-trading score telemetry EA source"),
    ]:
        put(
            {
...
def update_control_records(onnx_summary: dict[str, Any], attempt_summary: dict[str, Any], closeout: dict[str, Any]) -> None:
    ...
    next_work = {
        ...
        "acceptance_criteria": [
            "execute prepared validation and research_oos MT5 cost/risk/holding score-probe attempts",
        ...
        "next_action": "execute_prepared_wave02_cost_risk_holding_l4_strategy_tester_attempts",
        "path": NEXT_WORK_ITEM.as_posix(),
        "summary": "Execute Wave02 cost/risk/holding prepared L4 Strategy Tester score-probe attempts.",
        "provenance": {
            "source": "wave02_cost_risk_holding_l4_materialization_preflight",
            "campaign_id": CAMPAIGN_ID,
    ...
    resume["cursor_state"] = "active_wave02_cost_risk_holding_l4_attempts_prepared_terminal_execution_next"
    ...
    goal["next_work_item"] = {
        "work_item_id": NEXT_WORK_ITEM_ID,
        "path": NEXT_WORK_ITEM.as_posix(),
        "summary": "Execute prepared Wave02 cost/risk/holding L4 score-probe attempts.",
    }
    ...
    workspace["next_action"] = "Execute prepared Wave02 cost/risk/holding L4 score-probe attempts."
    ...
    workspace["wave02_cost_risk_holding_l4_materialization"] = {
        "campaign_id": CAMPAIGN_ID,
        "status": CAMPAIGN_STATUS,
        "claim_boundary": NEXT_CLAIM_BOUNDARY,
        "onnx_materialization_summary": ONNX_SUMMARY.as_posix(),
    ...
    workspace.setdefault("summary_counts", {})["wave02_cost_risk_holding_l4_materialization"] = {
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Materialize Wave02 cost/risk/holding ONNX bundles and prepared L4 MT5 attempts.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    command_argv = sys.argv[:] if argv is None else ["foundation/pipelines/materialize_wave02_cost_risk_holding_l4_preflight.py", *argv]
