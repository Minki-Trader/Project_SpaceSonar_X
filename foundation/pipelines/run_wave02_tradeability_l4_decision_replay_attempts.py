...
WORK_ITEM_ID = "work_wave02_tradeability_decision_replay_runtime_execution_v0"
SUBWORK_ID = "work_wave02_tradeability_decision_replay_strategy_tester_execution_v0"
NEXT_WORK_ID = "work_wave02_tradeability_decision_replay_judgment_v0"
...
SUMMARY_ID = "wave02_tradeability_decision_replay_runtime_execution_summary_v0"

CLAIM_BOUNDARY = (
    "wave02_decision_replay_runtime_observation_only_"
    "no_runtime_authority_no_economics_pass_no_candidate_no_live_readiness_no_goal_achieve"
)
SUMMARY_CLAIM_BOUNDARY = (
    "wave02_decision_replay_runtime_execution_progress_only_"
    "no_runtime_authority_no_economics_pass_no_candidate_no_live_readiness_no_goal_achieve"
)
NEXT_CLAIM_BOUNDARY = (
    "wave02_decision_replay_judgment_pending_"
    "no_runtime_authority_no_economics_pass_no_candidate_no_live_readiness_no_goal_achieve"
)

PARTIAL_STATUS = "partial_wave02_decision_replay_terminal_execution_started"
ALL_ATTEMPTS_STATUS = "wave02_decision_replay_terminal_execution_attempted_for_all_prepared_attempts"
...
CLOSEOUT_PATH = Path(
    ...
    "work_wave02_tradeability_decision_replay_strategy_tester_execution_v0_closeout.yaml"
)
...
def normalize_attempt_outputs(repo_root: Path, row: dict[str, str], execution_row: dict[str, Any]) -> dict[str, Any]:
    ...
    if terminal_path.exists():
        ...
        terminal["version"] = "wave02_tradeability_decision_replay_terminal_run_summary_v1"
        ...
        terminal["claim_boundary"] = (
            ...
            else "wave02_decision_replay_terminal_not_launched_no_runtime_completion_claim"
        )
    ...
    if telemetry_path.exists():
        ...
        telemetry["version"] = "wave02_tradeability_decision_replay_execution_telemetry_summary_v1"
    ...
    if tester_log_path.exists():
        ...
        tester_log["version"] = "wave02_tradeability_decision_replay_tester_log_summary_v1"
        ...
        tester_log["claim_boundary"] = "wave02_decision_replay_tester_log_observation_only_no_economics_pass"
    ...
    routing["routing_scope"] = "wave02_tradeability_l4_score_replay_decision_execution"
...
def normalize_summary(summary: dict[str, Any]) -> dict[str, Any]:
    summary["version"] = "wave02_tradeability_decision_replay_runtime_execution_summary_v1"
...
def normalize_compile_summary(compile_summary: dict[str, Any]) -> dict[str, Any]:
    compile_summary["version"] = "wave02_tradeability_decision_replay_runtime_compile_summary_v1"
    ...
    compile_summary["claim_boundary"] = "wave02_decision_replay_ea_compile_or_binary_preflight_only_not_strategy_tester_output"
...
def upsert_artifact_registry(repo_root: Path, summary: dict[str, Any], execution_rows: list[dict[str, Any]]) -> None:
    ...
    for artifact_id, artifact_type, path, notes in [
        ...
        (
            "artifact_wave02_decision_replay_ea_source_v0",
            "mt5_ea_source",
            base.EA_SOURCE,
    ...
    if (repo_root / base.EA_BINARY).exists():
        put(
            {
                "artifact_id": "artifact_wave02_decision_replay_ea_binary_v0",
                ...
                "consumer": WORK_ITEM_ID,
                "claim_boundary": "wave02_decision_replay_ea_compile_or_binary_preflight_only_not_strategy_tester_output",
...
def next_work_payload(summary: dict[str, Any]) -> dict[str, Any]:
    if summary["status"] == PARTIAL_STATUS:
        return {
            ...
            "parent_work_item_id": "work_wave02_tradeability_l4_decision_replay_adapter_preparation_v0",
            ...
            "claim_boundary": summary["claim_boundary"],
            "next_action": summary["judgment"]["next_action"],
            "status": "wave02_decision_replay_terminal_execution_in_progress",
            "current_truth": {
    ...
    return {
        ...
        "status": "wave02_decision_replay_pair_judgment_pending",
        "current_truth": {
            "decision_replay_runtime_execution_summary": RUNTIME_SUMMARY.as_posix(),
            "decision_replay_runtime_execution_index": RUNTIME_INDEX.as_posix(),
            "decision_replay_runtime_execution_status": summary["status"],
...
def update_control_records(repo_root: Path, summary: dict[str, Any]) -> None:
    ...
    counts["candidate_count"] = 0
    counts["l5_candidate_count"] = 0
    counts["wave02_decision_replay_runtime_execution"] = summary["counts"]
    ...
    if (repo_root / GOAL_REGISTRY).exists():
        ...
        for row in goal_rows:
            if row.get("goal_id") == GOAL_ID:
                ...
                row["claim_boundary"] = "active_goal_wave02_decision_replay_runtime_progress_not_goal_achieve"
        if goal_rows:
...
def writer_scope_self_check(repo_root: Path, summary: dict[str, Any]) -> dict[str, Any]:
    ...
    for artifact_id, path in [
        ("artifact_wave02_decision_replay_runtime_execution_summary_v0", RUNTIME_SUMMARY),
        ("artifact_wave02_decision_replay_runtime_execution_index_v0", RUNTIME_INDEX),
        ("artifact_wave02_decision_replay_runtime_execution_closeout_v0", CLOSEOUT_PATH),
    ]:
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run prepared Wave02 tradeability decision replay MT5 attempts.")
...
def build_command_argv(args: argparse.Namespace) -> list[str]:
    command = ["python", "foundation/pipelines/run_wave02_tradeability_l4_decision_replay_attempts.py"]
