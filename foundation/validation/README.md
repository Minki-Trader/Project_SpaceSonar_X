...
Default operation must not call `pytest`, full active-record validation, or full control-plane validation for ordinary run writing. Use the writer-scope smoke first; escalate only at campaign/wave boundaries, protected claim changes, or source-of-truth drift.
