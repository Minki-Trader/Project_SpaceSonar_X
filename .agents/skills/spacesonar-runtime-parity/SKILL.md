...
- Attempt-first is not heavy-first: prove new ONNX/EA/MT5 plumbing with the thinnest fixture, adapter, or probe path first, then expand to the full L4 batch after the path is real.
